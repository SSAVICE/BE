...
public enum ErrorCode {
    ...
    NOT_SERVICE_OWNER(HttpStatus.FORBIDDEN, "NOT_SERVICE_OWNER", "해당 서비스의 소유주가 아닙니다."),
    AT_MINIMUM_MEMBER_LIMIT(HttpStatus.CONFLICT, "AT_MINIMUM_MEMBER_LIMIT", "최소 참여 인원이 충족되어 취소가 불가능합니다."),
